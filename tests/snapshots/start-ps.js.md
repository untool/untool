...
> Snapshot 2
    ...
    [
      {
        _config: {
          arbitraryValue: '[ENV_VAR=some-arbitrary-string]',
          assetPath: '',
          basePath: '',
          browsers: [
            'defaults',
        ...
        _env: {
          ENV_VAR: 'some-arbitrary-string',
          HOST: '',
          PORT: '',
        },
        arbitraryValue: 'some-arbitrary-string',
        assetPath: '',
        basePath: '',
        browsers: [
          'defaults',
...

    {
      body: `<!DOCTYPE html><html><head>␊
        ...
        <body>␊
          ...
          ␊
          <script>␊
            var _env={"HOST":"","PORT":"","ENV_VAR":"some-arbitrary-string"};␊
          </script>␊
