...

    {
      body: `<!DOCTYPE html><html><head>␊
        ...
        <body>␊
          ...
          <script src="/untest-1.js"></script><script src="/untest-4.js"></script><script src="/untest-2.js"></script><script src="/untest.js"></script>␊
        ␊
      </body></html>`,
    }
    ...
    InstrumentMixin {
      ...
      config: {
        _config: {
          ...
          distDir: './tests/fixtures/untest/dist/public',
          host: '[HOST]',
          https: false,
          locations: [
            '/',
          ...
          serverDir: './tests/fixtures/untest/dist',
          serverFile: 'server.js',
          statsFile: 'stats.json',
          version: '0.0.0',
        },
...
> Snapshot 9

    {
      ...
      output: {
        ...
        path: './tests/fixtures/untest/dist/public',
        pathinfo: true,
        publicPath: '/',
      },
      performance: {
