...
> Snapshot 7

    {
      body: `<!DOCTYPE html><html><head>␊
        ...
        <body>␊
          <div data-mountpoint="" data-mounted=""><a href="/">Home</a> <a href="/about/">About</a><img src="/logo9628.svg" width="200" height="200" alt=""><h1>Home</h1></div>␊
          ␊
          <script>␊
            var _env={};␊
          </script>␊
          <script src="/untest-1.js"></script><script src="/untest-2.js"></script><script src="/untest-4.js"></script><script src="/untest.js"></script>␊
        ␊
      </body></html>`,
    }
...

    {
      ...
      resolve: {
        alias: {
          ...
          'react-helmet': './packages/react/lib/react-helmet-shim.js',
        },
        extensions: [
          '.mjs',
          '.js',
...
> Snapshot 8

    {
      ...
      <html >␊
        ...
        <body >␊
          <div data-mountpoint><a href="/">Home</a> <a href="/about/">About</a><img src="/logo9628.svg" width="200" height="200" alt=""/><h1>Home</h1></div>␊
          ␊
          <script>␊
            var _env={};␊
          </script>␊
