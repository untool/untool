...

    {
      body: `<!DOCTYPE html><html><head>␊
        ...
        <body>␊
          ...
          <script src="/untest-3.js"></script><script src="/untest-4.js"></script><script src="/untest-1.js"></script><script src="/untest.js"></script>␊
        ␊
      </body></html>`,
    }
      ...
      config: {
        ...
        _mixins: {
          browser: [
            ...
            './tests/helpers/instrument/mixin.browser.js',
          ],
          core: [
            ...
            './tests/helpers/instrument/mixin.core.js',
          ],
          server: [
            './packages/react/mixins/mixin.server.js',
            './tests/helpers/instrument/mixin.server.js',
          ],
        },
        _presets: [
          '@untool/yargs',
